...
const ReportTest= () => {
  ...
  useEffect(() => {
    fetchData('66b326e41f6cf39544a2b438');
  }, [ ]);
    ...
    if (!objectPair || !arr || arr.length == 0) {
      ...
      for (let i = 0; i < detractorCounts.length; i++) {
        ...
        if (val == 0) npsCounts[i] = 0;
          ...
          npsCounts[i] = (
            ((promoterCounts[i] - detractorCounts[i]) / val) *
            100
          ).toFixed(2);
      }
      const maxValue = arr.reduce(
        (val, ele) => (Number(val) > ele ? val : ele),
        0
      );
      ...
      options = {
        ...
        scales: {
          ...
          y: {
            min: 0,
            max:
              Math.ceil(maxValue) + Math.ceil(maxValue / 5) > 5
                ? Math.ceil(maxValue) + Math.ceil(maxValue / 5)
                : 5,
            ticks: {
  ...
  const fetchData = async (scale_id) => {
    try {
      ...
      data.forEach((item) => {
        ...
        if (
          trimmedName !== "instance_${index 1}" &&
          !uniqueInstances.has(trimmedName)
        ) {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen">
        <CircularProgress /> 
        <p className="ml-4 font-poppins font-medium">Hang tight, we're gathering your reports...</p>
      </div>
    );
  }
  if (err) {
    return (
      <>
        <p className="w-screen h-screen flex justify-center items-center p-2 text-red-600">
      ...
      <div className="z-10">
        ...
        <div className="-z10">
          <Box p={1}>
            ...
            {msg && (
              <p className="text-red-500 self-center w-full flex justify-center">
                Provide feedback to check report
              </p>
            )}
            <Grid
              container
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <MenuItem     key={1}   value={7}  >  7 days  </MenuItem>
                  <MenuItem     key={2}    value={30}   >     30 days  </MenuItem>
                  <MenuItem     key={3}      value={90}  >   90 days </MenuItem>
                </Select>
              </Grid>
            </Grid>
            {selectedChannel === allChannelsNameTag ? (
                  ...
                  displayDataForAllSelection.map((item, index) => {
                    return (
                      <>
                        ...
                        >
                          {index + 1}.{" "}
                          {instanceNames[item?.instanceName.trim()]}
                        </Typography>
                        <div className="flex justify-center items-center gap-6 sm:gap-12 mt-10 flex-wrap">
                          ...
                          <p className="text-[20px] font-bold text-blue-600 mb-2">
                            NPS:{" "}
                            {(
                              scores.Promoter.percentage -
                              scores.Detractor.percentage
                            ).toFixed(2)}
                          </p>
                        </div>
                        <div className="flex flex-col lg:flex-row justify-center md:gap-3 items-center w-[100%]">
                          <div className="w-[90%] md:w-1/2 flex flex-col justify-start items-start">
                            <p className="text-center font-medium p-2 w-full mt-2">
                              Total Score:
                            </p>
                            <div
                              style={{
                            ...
                            >
                              ...
                              >
                                <span
                                  className={`absolute font-bold text-[12px] text-blue-600 ${
                                    item?.totalResponses == 0 && "hidden"
                                  }`}
                                  style={{
                                    right: 0,
                                    bottom: "-20px",
                          ...
                          <div className="w-[90%] md:w-1/2 flex flex-col justify-start items-start mb-[10px]">
                            <p className="text-center font-medium p-2 w-full">
              ...
              <>
                    ...
                    >
                      ...
                      >
                        <div
                          style={{
                            width: `${
                              (totalScore / (totalCount * 10)) * 100 || 0
                            }%`,
                ...
                >
                  ...
                  selectedInstance.length < 1 ? null : (
                    <>
                      <Box
                        sx={{
                          mt: 4,
