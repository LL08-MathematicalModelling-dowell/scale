...
def send_email(toname, toemail, subject, date, button_link, qrcode_image_link):
    ...
    <body>
        <div class="email-container">
            <div class="logo-container">
                <img src="https://dowellfileuploader.uxlivinglab.online/hr/logo-2-min-min.png" alt="Company Logo">
            </div>
            <div class="content">
                <p class="greeting">Hey {toemail},</p>
                <p>Date: {date}</p>
                <p>We’ve prepared the report based on your feedback. Click below to view your personalized report.</p>
                <a href="{button_link}" class="button">View My Report</a>
            </div>
            <div class="qrcode-container">
                <p>Or scan this QR code to access the report:</p>
                <img src="{qrcode_image_link}" alt="QR Code">
            </div>
            <div class="content">
